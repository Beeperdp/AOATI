...
public class BlockVirusAdamantium extends Block {
public IIcon[] icons = new IIcon[6];
	
	public BlockVirusAdamantium(Material material){
		super(material);
		this.setHardness(345F);
		this.setBlockName("blockVirusAdamantium");
		this.setBlockTextureName("aoati:blockVirusAdamantium");
	...
	public void updateTick(World world, int x, int y, int z, Random rand){
        ...
        Block blok = aoati.blockAdamantiumOre;
        for(int i=0;i<10;i++){
        	if(i == 0){
        		Block preblock = world.getBlock(x+1, y, z);
        		if(preblock == Blocks.bedrock == false && preblock == aoati.blockVirusRemoval == false && preblock == Blocks.air == false && preblock == aoati.blockVirusAdamantium == false && preblock == Blocks.tallgrass == false && preblock == blok == false && preblock == Blocks.water == false && preblock == Blocks.lava == false && preblock == Blocks.flowing_lava == false && preblock == Blocks.flowing_water == false){
        			dx = x+1;
        			dy = y;
        			dz = z;
        			world.setBlock(dx, dy, dz, aoati.blockVirusAdamantium);
        		}
        	}else if(i == 1){
        		Block preblock = world.getBlock(x-1, y, z);
        		if(preblock == Blocks.bedrock == false && preblock == aoati.blockVirusRemoval == false && preblock == Blocks.air == false && preblock == aoati.blockVirusAdamantium == false && preblock == Blocks.tallgrass == false && preblock == blok == false && preblock == Blocks.water == false && preblock == Blocks.lava == false && preblock == Blocks.flowing_lava == false && preblock == Blocks.flowing_water == false){
