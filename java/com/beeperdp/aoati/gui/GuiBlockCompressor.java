package com.beeperdp.aoati.gui;
...
public class GuiBlockCompressor extends GuiContainer{
	private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("aoati", "textures/gui/compressor.png");
	private TileEntityBlockCompressor tileFurnace;

	public GuiBlockCompressor(InventoryPlayer invPlayer, TileEntityBlockCompressor tile) {
		super(new ContainerBlockCompressor(invPlayer, tile));
