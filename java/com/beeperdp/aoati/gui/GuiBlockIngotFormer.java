...
public class GuiBlockIngotFormer extends GuiContainer{
	private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("aoati", "textures/gui/ingotformer.png");
	private TileEntityBlockIngotFormer tileFurnace;

	public GuiBlockIngotFormer(InventoryPlayer invPlayer, TileEntityBlockIngotFormer tile) {
		super(new ContainerBlockIngotFormer(invPlayer, tile));
