...
public class ItemTeleporter extends Item{
	...
	public ItemStack onItemRightClick(ItemStack item, World world, EntityPlayer player){
		...
		return suitable(world, player, item);
}
	
public static ItemStack suitable(World world, EntityPlayer player, ItemStack item){
	...
	private static int findSuitableYPos(World world, int x, int z, int lowest, EntityPlayer player) {
		int y = 0;
