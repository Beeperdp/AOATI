...
public class ContainerBlockCompressor extends Container {
	...
	public ContainerBlockCompressor(InventoryPlayer player, TileEntityBlockCompressor tileEntityFurnace){
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int par2){
		...
		if(slot != null && slot.getHasStack()){
			...
			if(par2 == 2){
				...
				if(BlockCompressorRecipes.smelting().getSmeltingResult(itemstack1) != null){
					if(!this.mergeItemStack(itemstack1, 0, 1, false)){
						return null;
					}
				}else if(TileEntityBlockCompressor.isItemFuel(itemstack1)){
